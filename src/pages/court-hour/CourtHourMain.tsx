        ...
        <>
            <div className="flex justify-center">
                ...
                <div className="w-1/5 p-4 flex justify-center items-end">
                    <button className = "w-full p-2 rounded bg-button1 hover:bg-button1_hover text-button1_text transition duration-200" onClick={onSaveClick}>Guardar cambios</button>
                </div>
            </div>
            <CalendarCourtHour 
                month={month} 
